      ...
      <div className="footer-main">
        <div className="footer-brand">
          ...
          <p className="footer-desc">
            Nepal's premier online gym gear & supplement store. Delivering
            quality fitness products since 2022.
          </p>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            <li>
              <Link to="/products?category=gym-gears">Gym Gears</Link>
            </li>
            <li>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-contact">
            <li>
              <FaMapMarkerAlt color="#ff6b00" /> Putalisadak, Kathmandu, Nepal
            </li>
            <li>
              <FaPhone color="#ff6b00" /> +977-1-4012345
            </li>
            <li>
              <FaEnvelope color="#ff6b00" /> info@ironforge.com.np
            </li>
            <li>
              <FaClock color="#ff6b00" /> Sun-Fri: 9AM - 6PM
            </li>
          </ul>
        </div>
      </div>
